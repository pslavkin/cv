\subsection{\href{https://www.argentina.gob.ar/comision-nacional-de-energia-atomica}{Comisión Nacional de Energía Atómica}}
   ...
   Luego se desarrollo el software de adquisición y análisis de los datos
   crudos obtenidos del equipo mostrado en la figura \ref{fig:cnea2}.
   \begin{figure}
      \begin{center}
      ...
      \end{center}
      \caption{Mesa CNC para automatización de adquisiciones con una captura del software de manejo, la placa con la FPGA y uno de los 6 cabezales del Tomógrafo}
      \label{fig:cnea1}
   \end{figure}
   \begin{figure}
      \begin{center}
         \includegraphics[width=0.24\textwidth]{portfolio/cnea_cuipet1.jpg}
         \includegraphics[width=0.24\textwidth]{portfolio/cnea_cuipet2.jpg}
