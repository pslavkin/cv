\subsection{\href{http://www.wolfcut.es/}{Wolfcut}}
   ...
   En la figura \ref{fig:wolfcut_capas} se puede ver el modelo de capas implementado y la pagina web de control.
     \begin{figure}
      \begin{center}
         \includegraphics[width=0.3\textwidth]{portfolio/wolfcut1.png}
         \includegraphics[width=0.3\textwidth]{portfolio/wolfcut2.png}
         \includegraphics[width=0.3\textwidth]{portfolio/wolfcut3.png}
      \end{center}
   ...
   En las figuras \ref{fig:wolfcut_implementacion} se pueden ver capturas del sistema de compilación.
     ...
     \begin{figure}
      \begin{center}
         \includegraphics[width=0.3\textwidth]{portfolio/wolfcut4.png}
         \includegraphics[width=0.3\textwidth]{portfolio/wolfcut5.png}
         \includegraphics[width=0.3\textwidth]{portfolio/wolfcut6.png}
      \end{center}
