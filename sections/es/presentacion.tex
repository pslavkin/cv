...
En el CV encontraran mas detalle siguiendo los links a recursos externos como url's, videos y pdf's.\\
  \begin{figure}
      \begin{center}
         \includegraphics[width=0.3\textwidth]{portfolio/ofi_dci1.png}
         \includegraphics[width=0.3\textwidth]{portfolio/ofi_dci2.png}
         \includegraphics[width=0.3\textwidth]{portfolio/ofi_dci5.png}
      \end{center}
