...
\section{Dominio de tecnologías}
	...
	\cvitem{Intermedio} 	{\LaTeX, OpenOffice, LibreOffice, Matlab, Mathcad, quemu, Arduino, svn, Openscam, Webadmin}
	...
	\cvitem{Intermedio} 	{IPv6, CAN, 6LoWPAN, IEEE 802.15.4, I2S, Radiuos}
	\cvitem{Básico} 	{}
	
	\subsection{Otras tecnologías de Interés}
	\cvitem{Avanzado} 	{Manejo de línea de montaje SMD, Soldado de PCB's, Impresión 3D FDM, serigrafía sobre rigido, serigrafía de PCB's,  mecanizado CNC, Manejo de maquina de corte laser, manejo de máquinas herramientas}
